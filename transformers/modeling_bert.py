...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None, sentence_positions=None):
        ...
        if sentence_positions is not None:
            sentence_positions_embeddings = self.sentence_positions_embeddings(sentence_positions)
        else:
            sentence_positions_embeddings = torch.zeros(token_type_embeddings.shape, device=token_type_embeddings.device)

        embeddings = inputs_embeds + position_embeddings + token_type_embeddings + sentence_positions_embeddings
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None, sentence_positions=None,
        ...
        embedding_output = self.embeddings(input_ids=input_ids, position_ids=position_ids, token_type_ids=token_type_ids, inputs_embeds=inputs_embeds, sentence_positions=sentence_positions)
